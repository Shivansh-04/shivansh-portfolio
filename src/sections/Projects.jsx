...
const PROJECTS = [
  {
    ...
    description: 'A full-stack mental health platform powered by AI that provides personalized support, mood tracking, and resource recommendations. Built with a focus on accessibility and user privacy.',
    tags: ['React', 'Node.js', 'MongoDB', 'AI', 'Express'],
    category: ['Full Stack', 'AI/ML'],
    featured: true,
    github: 'https://github.com/shivansh',
    live: '#',
    challenges: 'Implementing real-time AI responses while maintaining data privacy and low latency.',
    panel: 'A',
  },
  {
    id: 2,
    name: 'SurakshaSetu',
    tagline: 'AI-powered crime reporting platform',
    description: 'An intelligent crime reporting system that uses AI to categorize incidents, route reports to appropriate authorities, and provide real-time status updates to citizens.',
    tags: ['MERN', 'AI', 'Maps API', 'Socket.io'],
    category: ['Full Stack', 'AI/ML'],
    featured: true,
    github: 'https://github.com/shivansh',
    live: '#',
    challenges: 'Integrating multiple government APIs and ensuring reliable real-time communication.',
    panel: 'B',
  },
  {
    id: 3,
    ...
    description: 'A visual tool that animates popular sorting algorithms in real-time, helping students understand how algorithms work through interactive step-by-step animations.',
    tags: ['JavaScript', 'React', 'NODEJS', 'CSS Animations'],
    category: ['Visualizer'],
    featured: false,
    github: 'https://github.com/shivansh',
    live: '#',
    challenges: 'Achieving smooth 60fps animations for large arrays while maintaining algorithm accuracy.',
    panel: 'C',
  },
  {
    id: 4,
