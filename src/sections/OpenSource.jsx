...
const STATS = [
  { label: 'DSA FOCUS', value: 200, suffix: '+', sub: 'Problems across LeetCode & CodeChef', panel: 'A' },
  { label: 'FULL STACK', value: 3, suffix: 'x', sub: 'Production-grade MERN projects shipped', panel: 'B' },
  { label: 'AI INTEGRATION', value: 2, suffix: 'x', sub: 'Projects with real AI/ML pipelines', panel: 'C' },
]
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: index === 1 ? 'rgba(255,255,255,0.1)' : 'rgba(13,13,15,0.12)' }}
      />
  ...
  return (
    ...
    >
          ...
          >
            ...
            <div className="flex flex-col mt-6">
              ...
              <p
                ...
                style={{ fontSize: 'clamp(16px, 2vw, 22px)', letterSpacing: '0.06em', lineHeight: 1.2 }}
              >
                {h.name}
              </p>
              ...
              <p
                ...
                style={{ fontSize: 12, color: 'rgba(13,13,15,0.45)', fontStyle: 'italic' }}
              >
                {h.role}
              </p>
            </div>
      ...
      >
        ...
        <div
          className="absolute top-4 left-4"
          style={{ border: '1.5px solid rgba(255,255,255,0.2)', padding: '2px 8px' }}
        >
        ...
        <div className="flex items-start gap-5 pt-4">
          ...
          <div>
            ...
            >
              <span className="font-manga text-white opacity-50" style={{ fontSize: 9, letterSpacing: '0.2em' }}>
                ACTIVE QUEST
              </span>
            </div>
            ...
            <p
              ...
              style={{ fontSize: 'clamp(18px, 2.5vw, 28px)', letterSpacing: '0.06em', lineHeight: 1.2 }}
            >
              Google Summer of Code
            </p>
            <p
              className="font-body mt-2"
              style={{ fontSize: 13, color: 'rgba(255,255,255,0.45)', lineHeight: 1.7, maxWidth: 420 }}
            >
              Targeting GSoC 2026 — reading codebases, filing issues, and building context in web & AI orgs.
            </p>
          </div>
        </div>
